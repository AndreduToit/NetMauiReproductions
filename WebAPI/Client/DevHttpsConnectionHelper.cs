...
namespace MauiClient
{
    public class DevHttpsConnectionHelper
    {
        public DevHttpsConnectionHelper(int sslPort)
        {
            ...
            {
                var tHttpMessageHandler = GetPlatformMessageHandler();
                return (tHttpMessageHandler == null) ? new HttpClient() : new HttpClient(tHttpMessageHandler);
            });
        }
        ...
        internal sealed class CustomAndroidMessageHandler : Xamarin.Android.Net.AndroidMessageHandler
        {
            ...
            private sealed class CustomHostnameVerifier : Java.Lang.Object, Javax.Net.Ssl.IHostnameVerifier
            {
                ...
                {
                    return
                        Javax.Net.Ssl.HttpsURLConnection.DefaultHostnameVerifier?.Verify(hostname, session) ?? false
